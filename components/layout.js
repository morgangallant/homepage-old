  ...
  const metadata = () => {
    return (
      <Head>
        ...
        <meta property="og:description" content="Morgan's home on the internet." />
        <meta property="og:image" content="https://morgangallant.com/images/profile.jpg" />

        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://morgangallant.com/" />
        <meta property="twitter:title" content="Morgan Gallant" />
        <meta property="twitter:description" content="Morgan's home on the internet." />
        <meta property="twitter:image" content="https://morgangallant.com/images/profile.jpg" />
